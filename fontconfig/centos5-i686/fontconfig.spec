...
# the fontconfig tarball doesn't ship man1 pages.  so we install ours
install -m 0644 %{SOURCE10} $RPM_BUILD_ROOT%{_mandir}/man1
install -m 0644 %{SOURCE11} $RPM_BUILD_ROOT%{_mandir}/man1
install -m 0644 %{SOURCE12} $RPM_BUILD_ROOT%{_mandir}/man1
install -m 0644 %{SOURCE13} $RPM_BUILD_ROOT%{_mandir}/man1
...
%changelog
* Tue Aug 10 2010 John Ford <jhford@mozilla.com> - 2.4.2-1
- Rebuild using version 2.4.2

* Fri Aug 24 2007 Behdad Esfahbod <besfahbo@redhat.com> - 2.4.1-7
- Add Liberation fonts to 30-aliases-fedora.conf
- Resolves: #243049

* Tue Jan 16 2007 Behdad Esfahbod <besfahbo@redhat.com> - 2.4.1-6
- Don't build docs.
- Include man1 pages as sources.
- Resolves: #222719

* Fri Oct 13 2006 Matthias Clasen <mclasen@redhat.com> - 2.4.1-5
- Rebuild
