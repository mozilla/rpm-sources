##### MOZILLA SPECIFIC SPEC FILE #####
# This spec file is used to generate systemtap-sdt-devel packages for our
# CentOS 5.0 build machines. To minimize build dependencies the following
# changes have been made to it:
#  - Disable docs
#  - Comment out some files from the -runtime and -server %files sections,
#    because we don't care about them, and don't want to install the
